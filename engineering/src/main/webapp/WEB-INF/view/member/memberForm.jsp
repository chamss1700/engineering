...
<form action="memJoin" method="post" name="frm">
    <table border="1" align="center">
         ...
         <tr><td>비밀번호 확인</td><td>
              </td><input type="password" name="membPwCon" /> </tr>
         <tr><td>이름</td>
         ...
         <tr><td>생년월일</td>
              <td><input text="text" name="membBirth" /></td></tr>
         <tr><td>성별</td>
              <td><input type="radio" name="membGender" value="M">남자
              <td><input type="radio" name="membGender" value="F">여자
              </td></tr>
         <tr><td>이메일</td>
         ...
         <tr><td>이메일수신여부</td>
            <td><input type="radio" name="membConfirm" value="Y" />예
                <input type="radio" name="membConfirm" value="N">아니오
            </td></tr>
